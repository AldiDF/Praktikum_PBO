...
public class Visitor extends User {
    ...
    public static void dataVisitor(){
        Visitor.pengunjung.add(new Visitor("user", "user", "user", "user", "user", "user"));
        Visitor.pengunjung.add(new Visitor("pengunjung", "pengunjung", "pengunjung", "pengunjung", "pengunjung", "pengunjung"));
    }
